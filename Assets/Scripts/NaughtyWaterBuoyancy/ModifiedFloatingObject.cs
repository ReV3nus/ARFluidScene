...
namespace NaughtyWaterBuoyancy
{
    ...
    public class ModifiedFloatingObject : MonoBehaviour
    {
        [SerializeField]
        ...
        private ModifiedWaterVolume water;
        ...
        protected virtual void OnTriggerEnter(Collider other)
        {
            ...
            {
                this.water = other.GetComponent<ModifiedWaterVolume>();
                if (this.voxels == null)
                {
        ...
        {
            if (other.CompareTag(ModifiedWaterVolume.TAG))
            {
                this.water = null;
            }
        }

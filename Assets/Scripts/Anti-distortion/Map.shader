    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float2 xy_r = uv2xy(i.uv, center, _FovX, _FovY, _F_R, _ScreenSize, float2(_ScreenOffsetX, _ScreenOffsetY));
                float2 xy_g = uv2xy(i.uv, center, _FovX, _FovY, _F_G, _ScreenSize, float2(_ScreenOffsetX, _ScreenOffsetY));
                float2 xy_b = uv2xy(i.uv, center, _FovX, _FovY, _F_B, _ScreenSize, float2(_ScreenOffsetX, _ScreenOffsetY));

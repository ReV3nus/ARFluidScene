    ...
    public class PinchSliderInspector : UnityEditor.Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            if (slider != null)
            {
                ...
                var fmh_48_21_638572583209460283 = Quaternion.identity; slider.SliderStartPosition = Handles.FreeMoveHandle(startPos,
                    handleSize,
                    Vector3.zero,
                    Handles.SphereHandleCap);
                var fmh_53_21_638572583209462410 = Quaternion.identity; slider.SliderEndPosition = Handles.FreeMoveHandle(endPos,
                    handleSize,
                    Vector3.zero,
                    Handles.SphereHandleCap);
